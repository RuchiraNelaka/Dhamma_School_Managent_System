...
<body>
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Add Attendance</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
				<form method="POST" action="ListAttendanceServlet">
			<input type="image" src="assets/images/CRUD/view_all.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="VIEW ALL RESULTS" alt="Submit">
                               ...
                               <div class="table-responsive">
                                    <form autocomplete="off" method="POST" action="AddAttendanceServlet" style="font-family: Arial, Helvetica, sans-serif; color: gray; ">
	<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        <br />
                        <label class="lablFont">Student ID </label>
                        <br />
                        <input id="stdId" name="stdId" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" pattern="[A-Za-z0-9]+" required>
                    </div>
                    </div>
     ...
     <div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        <br />
                        <label class="lablFont">Student Grade</label>
                        <br />
                        <input id="stdGrade" name="stdGrade" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" pattern="[0-9]{2}" required>
                    </div>
                    </div>
 ...
 <div class="col-md-8  h-100 w-100">
         <br />
                        <label class="lablFont">Time </label>
                        <br />
  <input type="time" name="stdArrivesTime" id="inputMDEx1" class="form-control">
                    </div>
    ...
    <div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Student Arrives Date </label>
                        <br />
                          
            <div class='input-group date' id='datetimepicker3'>
               <input type='text' id='stdArrivesDate' name='stdArrivesDate' class="form-control" style="color:#F8F8FF" onkeypress="return onlyNumberKey(event)" required/>
